...
class SqlContactBuilder:
    ...
    def get_contacts(self, chat_id):
        ...
        for contact in self.cursor.fetchall():
            id, chat_id, name, phone_number, discription = contact
            contacts.append(UserContact(name, phone_number, discription))
    ...
    def build(self, chat_id):
        ...
        self.cursor.execute("INSERT INTO Contacts (chat_id, name, phone_number, description) VALUES (?,?,?,?)",
                            [chat_id, current_contact.name, current_contact.phone_number, current_contact.discription])
